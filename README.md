...
If you're getting started and need assistance or face any bugs, feel free to reach out through my contact information.
...
```bash
git clone https://github.com/Udesy/nextjs-portfolio
cd portfolio
```
